...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#0D47A1">
        <div class="container">
            <a class="navbar-brand" href="{{ APP_URL }}"><i class="fas fa-store"></i> SandalShop</a>
    ...
    <main class="py-5">
        <div class="container">
            ...
            @php $successMsg = $_SESSION['success']; unset($_SESSION['success']); @endphp
            <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index:9999">
                <div id="successToast" class="toast align-items-center text-bg-success border-0 show" role="alert">
                    <div class="d-flex">
                        <div class="toast-body"><i class="fas fa-check-circle me-2"></i>{{ $successMsg }}</div>
            ...
            @php $errorMsg = $_SESSION['error']; unset($_SESSION['error']); @endphp
            <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index:9999">
                <div class="toast align-items-center text-bg-danger border-0 show" role="alert">
                    <div class="d-flex">
                        <div class="toast-body"><i class="fas fa-exclamation-circle me-2"></i>{{ $errorMsg }}</div>
                        <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast"></button>
                    </div>
                </div>
            </div>
